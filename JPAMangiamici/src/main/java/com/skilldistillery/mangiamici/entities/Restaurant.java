...
//		return "Restaurant [id=" + id + ", user=" + user + ", location=" + location + ", reviews=" + reviews
//				+ ", phone=" + phone + ", email=" + email + ", websiteEmail=" + websiteEmail + ", enabled=" + enabled
//				+ ", categories=" + categories + ", imgUrl=" + imgUrl + ", name=" + name + ", description="
//				+ description + ", menuUrl=" + menuUrl + "]";
//	}
