...
START TRANSACTION;
USE `mmdb`;
INSERT INTO `user` (`id`, `location_id`, `username`, `password`, `enabled`, `role`, `first_name`, `last_name`, `created_date`, `img_url`, `promo_opt`, `about_me`, `updated_date`, `user_status_id`) VALUES (1, 6, 'admin', '$2a$10$g/wF2jGxSYYjwwsSaaMXSeLDFKrA6aBQtXDNeDsyh4KP5Uun9cJfi', 1, 'admin', 'Jane', 'Doe', '2021-04-01 00:00:00', 'https://cdn.pixabay.com/photo/2015/07/20/12/57/ambassador-852766_960_720.jpg', TRUE, 'I like to think of myself as a random person with no personality but pleasant to talk and funny enough ', '2021-04-02 00:00:00', 1);
INSERT INTO `user` (`id`, `location_id`, `username`, `password`, `enabled`, `role`, `first_name`, `last_name`, `created_date`, `img_url`, `promo_opt`, `about_me`, `updated_date`, `user_status_id`) VALUES (2, 7, 'moderator', '$2a$10$T25qupotmcFRE9FCbQmBeum36jVGxIQMMAdfwYvmFx/hhTiJb01be', 1, 'moderator', 'John', 'Smith', '2021-04-01 00:00:00', 'https://cdn.pixabay.com/photo/2017/08/25/21/46/upset-2681502_960_720.jpg', TRUE, 'I am all things and no thins. I am a relatively existing, and breathing, but you could not prove anything to anybody', '2021-04-02 00:00:00', 2);
INSERT INTO `user` (`id`, `location_id`, `username`, `password`, `enabled`, `role`, `first_name`, `last_name`, `created_date`, `img_url`, `promo_opt`, `about_me`, `updated_date`, `user_status_id`) VALUES (3, 8, 'bokbok', '$2a$10$jC68KeZSSkpOY..6wqIsBuPKMgwCaYEU1xMbDDha2F80KOjT3s2ZK', 1, 'restaurant-owner', 'Elizabeth', 'Hurley', '2021-04-01 00:00:00', 'https://cdn.pixabay.com/photo/2016/07/03/19/33/eating-1495368_960_720.jpg', TRUE, 'Decent, funny, glamorous, always ready to dress up and go out for something to eat, but I get to pick', '2021-04-02 00:00:00', 1);
INSERT INTO `user` (`id`, `location_id`, `username`, `password`, `enabled`, `role`, `first_name`, `last_name`, `created_date`, `img_url`, `promo_opt`, `about_me`, `updated_date`, `user_status_id`) VALUES (4, 9, 'pizzathehut', '$2a$10$uDc8X7JFkZx2P.RvFiLrUeLpffT8/R0sMAZYnmKN4bGmqWmvVnVrO', 1, 'standard', 'Elon', 'Musk', '2021-04-01 00:00:00', 'https://static.independent.co.uk/2021/04/16/12/PRI150527856.jpeg', TRUE, 'I like to make things. Shiny techy things that might change the world one day. Maybe sometimes smoke, but mostly trying to eliminate greenhouse gases. I like to tinker.', '2021-04-02 00:00:00', 1);
INSERT INTO `user` (`id`, `location_id`, `username`, `password`, `enabled`, `role`, `first_name`, `last_name`, `created_date`, `img_url`, `promo_opt`, `about_me`, `updated_date`, `user_status_id`) VALUES (5, 10, 'foodtruckfinder', '$2a$10$miggZDY69ugZqD9akkvzxesS5nTKv.ewoq/10aag/kObJ95/BIuFy', 1, 'standard', 'Kate', 'McKinnon', '2021-04-01 00:00:00', 'https://cdn.pixabay.com/photo/2016/11/08/05/25/steak-1807532_960_720.jpg', TRUE, 'Never a dull moment, but then again, so is everybody else. I believe I am a good person to go out with, and I do mind it if you don\'t buy the drinks!', '2021-04-02 00:00:00', 5);
...
INSERT INTO `user` (`id`, `location_id`, `username`, `password`, `enabled`, `role`, `first_name`, `last_name`, `created_date`, `img_url`, `promo_opt`, `about_me`, `updated_date`, `user_status_id`) VALUES (8, 13, 'iamrex', '$2a$10$q4owX0hIeqKy4oc1glQve.AJIClUYLG2HbzLeH6xGNPS0ju3UzklG', 1, 'restaurant-owner', 'James', 'Jameson', '2021-04-01 00:00:00', 'https://cdn.pixabay.com/photo/2017/06/15/19/58/person-2406544_960_720.jpg', TRUE, 'The service business can be very rewarding, and having a place for families and friends to meet, and enjoy a great meal, is always a wonderful event.', '2021-04-02 00:00:00', 4);
...
INSERT INTO `friend` (`other_user_id`, `user_id`, `approved`, `date_requested`, `date_approved`) VALUES (1, 2, true, '2021-04-01 00:00:00', '2021-04-01 00:00:00');
INSERT INTO `friend` (`other_user_id`, `user_id`, `approved`, `date_requested`, `date_approved`) VALUES (2, 3, true, '2021-04-01 00:00:00', '2021-04-01 00:00:00');
INSERT INTO `friend` (`other_user_id`, `user_id`, `approved`, `date_requested`, `date_approved`) VALUES (4, 3, true, '2021-04-01 00:00:00', '2021-04-01 00:00:00');
INSERT INTO `friend` (`other_user_id`, `user_id`, `approved`, `date_requested`, `date_approved`) VALUES (4, 1, true, '2021-04-01 00:00:00', '2021-04-01 00:00:00');
INSERT INTO `friend` (`other_user_id`, `user_id`, `approved`, `date_requested`, `date_approved`) VALUES (2, 4, true, '2021-04-01 00:00:00', '2021-04-01 00:00:00');
INSERT INTO `friend` (`other_user_id`, `user_id`, `approved`, `date_requested`, `date_approved`) VALUES (6, 5, true, '2021-04-01 00:00:00', '2021-04-01 00:00:00');
INSERT INTO `friend` (`other_user_id`, `user_id`, `approved`, `date_requested`, `date_approved`) VALUES (3, 1, true, '2021-04-01 00:00:00', '2021-04-01 00:00:00');
INSERT INTO `friend` (`other_user_id`, `user_id`, `approved`, `date_requested`, `date_approved`) VALUES (3, 6, false, '2021-04-01 00:00:00', NULL);
INSERT INTO `friend` (`other_user_id`, `user_id`, `approved`, `date_requested`, `date_approved`) VALUES (1, 6, false, '2021-04-01 00:00:00', NULL);
INSERT INTO `friend` (`other_user_id`, `user_id`, `approved`, `date_requested`, `date_approved`) VALUES (2, 7, false, '2021-04-01 00:00:00', NULL);
INSERT INTO `friend` (`other_user_id`, `user_id`, `approved`, `date_requested`, `date_approved`) VALUES (3, 8, false, '2021-04-01 00:00:00', NULL);
INSERT INTO `friend` (`other_user_id`, `user_id`, `approved`, `date_requested`, `date_approved`) VALUES (4, 9, false, '2021-04-01 00:00:00', NULL);
INSERT INTO `friend` (`other_user_id`, `user_id`, `approved`, `date_requested`, `date_approved`) VALUES (5, 10, false, '2021-04-01 00:00:00', NULL);
INSERT INTO `friend` (`other_user_id`, `user_id`, `approved`, `date_requested`, `date_approved`) VALUES (6, 11, false, '2021-04-01 00:00:00', NULL);
INSERT INTO `friend` (`other_user_id`, `user_id`, `approved`, `date_requested`, `date_approved`) VALUES (7, 12, false, '2021-04-01 00:00:00', NULL);
INSERT INTO `friend` (`other_user_id`, `user_id`, `approved`, `date_requested`, `date_approved`) VALUES (8, 13, false, '2021-04-01 00:00:00', NULL);
...
START TRANSACTION;
USE `mmdb`;
INSERT INTO `review` (`id`, `user_id`, `restaurant_id`, `review_text`, `rating`, `enabled`, `created_date`, `updated_date`, `is_public`, `flagged`, `img_url`, `tagged_users`) VALUES (1, 5, 1, 'Best fried chicken I\'ve found in Denver so far...and its Korean style! Try the spicy, it\'s worth it.', 5, TRUE, '2021-04-01 00:00:00', '2021-04-02 00:00:00', TRUE, FALSE, NULL, NULL);
INSERT INTO `review` (`id`, `user_id`, `restaurant_id`, `review_text`, `rating`, `enabled`, `created_date`, `updated_date`, `is_public`, `flagged`, `img_url`, `tagged_users`) VALUES (2, 1, 2, 'The seafood is incredibly fresh and you can tell that the staff takes great pride in their craft.', 4, TRUE, '2021-04-01 00:00:00', '2021-04-02 00:00:00', TRUE, FALSE, NULL, NULL);
INSERT INTO `review` (`id`, `user_id`, `restaurant_id`, `review_text`, `rating`, `enabled`, `created_date`, `updated_date`, `is_public`, `flagged`, `img_url`, `tagged_users`) VALUES (3, 4, 3, 'I guess my favorite thing was the sauces because its the foundation of most of their dishes. Amazing!!', 4, TRUE, '2021-04-01 00:00:00', '2021-04-02 00:00:00', TRUE, TRUE, NULL, NULL);
INSERT INTO `review` (`id`, `user_id`, `restaurant_id`, `review_text`, `rating`, `enabled`, `created_date`, `updated_date`, `is_public`, `flagged`, `img_url`, `tagged_users`) VALUES (4, 7, 4, 'The French Toast has landed! I mean, it is rich and buttery, but full of complex flavor', 3, TRUE, '2021-04-01 00:00:00', '2021-04-02 00:00:00', FALSE, FALSE, NULL, NULL);
INSERT INTO `review` (`id`, `user_id`, `restaurant_id`, `review_text`, `rating`, `enabled`, `created_date`, `updated_date`, `is_public`, `flagged`, `img_url`, `tagged_users`) VALUES (5, 4, 5, 'Bravo! Seriously, the tapas at this Spanish restaurants are beautiful and super delicious', 5, TRUE, '2021-04-01 00:00:00', '2021-04-02 00:00:00', FALSE, FALSE, NULL, NULL);
INSERT INTO `review` (`id`, `user_id`, `restaurant_id`, `review_text`, `rating`, `enabled`, `created_date`, `updated_date`, `is_public`, `flagged`, `img_url`, `tagged_users`) VALUES (6, 11, 1, 'Fried to perfection, and the taste is divine. I can eat this all day, all week, everyday', 5, TRUE, '2021-04-01 00:00:00', '2021-04-02 00:00:00', TRUE, TRUE, NULL, NULL);
INSERT INTO `review` (`id`, `user_id`, `restaurant_id`, `review_text`, `rating`, `enabled`, `created_date`, `updated_date`, `is_public`, `flagged`, `img_url`, `tagged_users`) VALUES (7, 12, 2, 'Never been so disappointed in my life, and I like the water in Flint, Michigan', 1, TRUE, '2021-04-01 00:00:00', '2021-04-02 00:00:00', TRUE, FALSE, NULL, NULL);
INSERT INTO `review` (`id`, `user_id`, `restaurant_id`, `review_text`, `rating`, `enabled`, `created_date`, `updated_date`, `is_public`, `flagged`, `img_url`, `tagged_users`) VALUES (8, 13, 3, 'meh\' Its just another Italian restaurant. Service was very good, tho. ', 2, TRUE, '2021-04-01 00:00:00', '2021-04-02 00:00:00', TRUE, FALSE, NULL, NULL);
INSERT INTO `review` (`id`, `user_id`, `restaurant_id`, `review_text`, `rating`, `enabled`, `created_date`, `updated_date`, `is_public`, `flagged`, `img_url`, `tagged_users`) VALUES (9, 5, 4, 'Just what I was looking for! American cuisine done well and they have a large variety of dishes', 4, TRUE, '2021-04-01 00:00:00', '2021-04-02 00:00:00', TRUE, FALSE, NULL, NULL);
INSERT INTO `review` (`id`, `user_id`, `restaurant_id`, `review_text`, `rating`, `enabled`, `created_date`, `updated_date`, `is_public`, `flagged`, `img_url`, `tagged_users`) VALUES (10, 12, 5, 'I truly believe that the best food comes from Portugal and Spain, and this restaurant just confirmed it.', 5, TRUE, '2021-04-01 00:00:00', '2021-04-02 00:00:00', TRUE, FALSE, NULL, NULL);
