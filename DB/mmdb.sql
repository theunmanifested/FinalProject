...
START TRANSACTION;
USE `mmdb`;
INSERT INTO `review` (`id`, `user_id`, `restaurant_id`, `review_text`, `rating`, `enabled`, `created_date`, `updated_date`, `is_public`, `flagged`, `img_url`) VALUES (1, 5, 1, 'Best fried chicken I\'ve found in Denver so far...and its Korean style! Try the spicy, it\'s worth it.', 5, TRUE, '2021-04-01 00:00:00', '2021-04-02 00:00:00', TRUE, FALSE, NULL);
INSERT INTO `review` (`id`, `user_id`, `restaurant_id`, `review_text`, `rating`, `enabled`, `created_date`, `updated_date`, `is_public`, `flagged`, `img_url`) VALUES (2, 1, 2, 'The seafood is incredibly fresh and you can tell that the staff takes great pride in their craft.', 4, TRUE, '2021-04-01 00:00:00', '2021-04-02 00:00:00', TRUE, FALSE, NULL);
INSERT INTO `review` (`id`, `user_id`, `restaurant_id`, `review_text`, `rating`, `enabled`, `created_date`, `updated_date`, `is_public`, `flagged`, `img_url`) VALUES (3, 4, 3, 'I guess my favorite thing was the sauces because its the foundation of most of their dishes. Amazing!!', 4, TRUE, '2021-04-01 00:00:00', '2021-04-02 00:00:00', TRUE, TRUE, NULL);
INSERT INTO `review` (`id`, `user_id`, `restaurant_id`, `review_text`, `rating`, `enabled`, `created_date`, `updated_date`, `is_public`, `flagged`, `img_url`) VALUES (4, 7, 4, 'The French Toast has landed! I mean, it is rich and buttery, but full of complex flavor', 3, TRUE, '2021-04-01 00:00:00', '2021-04-02 00:00:00', FALSE, FALSE, NULL);
INSERT INTO `review` (`id`, `user_id`, `restaurant_id`, `review_text`, `rating`, `enabled`, `created_date`, `updated_date`, `is_public`, `flagged`, `img_url`) VALUES (5, 4, 5, 'Bravo! Seriously, the tapas at this Spanish restaurants are beautiful and super delicious', 5, TRUE, '2021-04-01 00:00:00', '2021-04-02 00:00:00', FALSE, FALSE, NULL);
INSERT INTO `review` (`id`, `user_id`, `restaurant_id`, `review_text`, `rating`, `enabled`, `created_date`, `updated_date`, `is_public`, `flagged`, `img_url`) VALUES (6, 11, 1, 'Fried to perfection, and the taste is divine. I can eat this all day, all week, everyday', 5, TRUE, '2021-04-01 00:00:00', '2021-04-02 00:00:00', TRUE, TRUE, NULL);
INSERT INTO `review` (`id`, `user_id`, `restaurant_id`, `review_text`, `rating`, `enabled`, `created_date`, `updated_date`, `is_public`, `flagged`, `img_url`) VALUES (7, 12, 2, 'Never been so disappointed in my life, and I like the water in Flint, Michigan', 1, TRUE, '2021-04-01 00:00:00', '2021-04-02 00:00:00', TRUE, FALSE, NULL);
INSERT INTO `review` (`id`, `user_id`, `restaurant_id`, `review_text`, `rating`, `enabled`, `created_date`, `updated_date`, `is_public`, `flagged`, `img_url`) VALUES (8, 13, 3, 'meh\' Its just another Italian restaurant. Service was very good, tho. ', 2, TRUE, '2021-04-01 00:00:00', '2021-04-02 00:00:00', TRUE, FALSE, NULL);
INSERT INTO `review` (`id`, `user_id`, `restaurant_id`, `review_text`, `rating`, `enabled`, `created_date`, `updated_date`, `is_public`, `flagged`, `img_url`) VALUES (9, 5, 4, 'Just what I was looking for! American cuisine done well and they have a large variety of dishes', 4, TRUE, '2021-04-01 00:00:00', '2021-04-02 00:00:00', TRUE, FALSE, NULL);
INSERT INTO `review` (`id`, `user_id`, `restaurant_id`, `review_text`, `rating`, `enabled`, `created_date`, `updated_date`, `is_public`, `flagged`, `img_url`) VALUES (10, 12, 5, 'I truly believe that the best food comes from Portugal and Spain, and this restaurant just confirmed it.', 5, TRUE, '2021-04-01 00:00:00', '2021-04-02 00:00:00', TRUE, FALSE, NULL);
